cc.Class({
    ...
    start: function () {
        ...
        if (mySeat.holds != null) {
            var myHoldLength = mySeat.holds.length;
            if (myHoldLength == 2 || myHoldLength == 5 || myHoldLength == 8 || myHoldLength == 11 || myHoldLength == 14) {
                mySeat.ismopai = true;
            }
        }
    ...
    initEventHandlers:function(){
        ...
        this.node.on('gang_notify',function(data){
            ...
            // self.setplayEfxAndAudio(localIndex, "play_gang", "nv/gang.mp3");
        ...
        this.node.on("ting_notify",function(data){
            ...
            // cc.vv.audioMgr.playMJGameSFX("nv/ting.mp3");
    ...
    onGameBeign:function() {
        ...
        if (cc.vv.gameNetMgr.conf && cc.vv.gameNetMgr.conf.paoType) {
    ...
    setHuaPaiList: function () {
        ...
        for(var i = 0; i < sides.length; ++i){
            ...
            this._huaShowCount.push(sideChild.getChildByName("huaShowCount"));
    ...
    showHuaPai: function (userid, data) {
        ...
        this._huaShowCount[localIndex].getComponent(cc.Label).string = 'x'+seatHuapaiLength;
        this._huaShowCount[localIndex].active = true;
        
        if (seatHuapaiLength >5 && localIndex != 0) {
            seatHuapaiLength = 1
    ...
    hideAllHuaPai: function () {
        ...
        for (var i = 0; i < this._huaPaiList.length; i++) {
            ...
            this._huaShowCount[i].active = false;
    ...
    chiOperation: function (data) {
        ...
        // this.setplayEfxAndAudio(localIndex, "play_chi", "nv/chi.mp3");
    ...
    showKDJPlayHu: function (localIndex, huType, gangchi, qianggang) {
        ...
        if(huType == 1){
            if (gangchi == true) {
                this.setplayEfxAndAudio(localIndex, "play_zimo", cc.CGameConfigDataModel.getAudioURLByOther("gangci"));
            }else {
            ...
            if (qianggang == true) {
                this.setplayEfxAndAudio(localIndex, "play_hu", cc.CGameConfigDataModel.getAudioURLByOther("qianggang"));
            }else {
    ...
    *******************************************/
    ...
    addOptions: function (actionData) {
        ...
        this.showErrorTip(actionData.gangIdArray, "actionData.gangIdArray");
        var gang_length = actionData.gangIdArray.length;
        var gang_show_index = 0;

        this.showErrorTip(this._options, "this._options");
        var options = this._options.getChildByName("options");
        this.showErrorTip(options, "options");

        this.showErrorTip(cc.vv.prefabMgr, "cc.vv.prefabMgr");
        var playOptionPrefab = cc.vv.prefabMgr.getPrefab("prefabs/Games/MJGame/ChuPai/Common/PlayOption");
        this.showErrorTip(playOptionPrefab, "playOptionPrefab");
        ...
        for (var i = 0; i < option_length; i++) {
            ...
            this.showErrorTip(playOption, "playOption");
            ...
            if (poScript) {
                ...
                this.showErrorTip(poScript, "poScript");
                poScript.init(playKey, mjid, this);
            }

            this.showErrorTip(options, "for options");
