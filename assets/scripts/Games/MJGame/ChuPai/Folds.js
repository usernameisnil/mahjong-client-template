cc.Class({
    ...
    hideAllFolds: function () {
        for (var k in this._folds) {
            ...
            for (var i in fold) {
                ...
                fold[i].getComponent(cc.Sprite).spriteFrame = null;               
    ...
    addFocusPrefab: function () {
        var focusPrefab = cc.vv.prefabMgr.getPrefab("prefabs/Games/MJGame/ChuPai/Common/FoldMJFocus");
