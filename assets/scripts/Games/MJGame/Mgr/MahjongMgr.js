...
cc.Class({
    ...
    getMahjongSpriteByID:function(id){
        ...
        if (id >= 42) {
            var distanceIndex = 0, init_index = 27;
            distanceIndex = id - 42;
            if (distanceIndex == 0) {
                id = init_index + 2;
            }else {
                id = init_index + distanceIndex - 1;
            }
        }
    ...
    getMahjongType:function(id){
        if(id >= 0 && id < 9){
            ...
            return 4;
        }else if ((id >= 34 && id < 42) || (id >= 42 && id < 45)) {
            return 5;
        }
    },
    ...
    getAudioURLByMJID:function(id,seatUserId){
        var realId = 0;
        if(id >= 0 && id < 9){
            realId = id + 21;
        }
        ...
        if (realId == 0) {
            ...
            return cc.CGameConfigDataModel.getMJItemData(gameName,mylanguage,sexName,realId);
