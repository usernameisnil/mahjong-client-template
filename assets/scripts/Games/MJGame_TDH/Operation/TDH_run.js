cc.Class({
    ...
    reSet:function(){
        ...
        for(var i = 0; i < this.tips.length; ++i){
            if (i == 0) {
                ...
                this.tips[i].node.getComponent(cc.Label).string = "请选择下漂";
            }else {
                this.tips[i].node.active = false;
                this.tips[i].node.getComponent(cc.Label).string = "已下漂";
            }
    ...
    initEventHandlers:function() {
        ...
        this.node.on('game_xiapao_notify',function(data){
            ...
            self.tips[localIndex].node.getComponent(cc.Label).string = "已下漂";
        });
      ...
      //  cc.log("run data = ", data);
        ...
        for(var i = 0; i < data.length; ++i){
            ...
            if (pao != null && pao >= 0) {
                ...
                this.tips[localIndex].node.getComponent(cc.Label).string = "已下漂";
            }
        }
    },
